    ...
    <body id="page-top">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1">
                        	<a href="login.jsp" class="nav-link py-3 px-0 px-lg-3 rounded ">
                        		로그인</a></li>
                        <li class="nav-item mx-0 mx-lg-1">
                        	<a href="insert.jsp" class="nav-link py-3 px-0 px-lg-3 rounded ">
                        		회원가입</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">회원 가입 하시면 도서 목록을 보실 수 있습니다</p>
            </div>
        </header>
</head>
<body>
